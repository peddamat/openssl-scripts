...
openssl asn1parse -genconf openssl-example3.asn1 -out openssl-example3.der -noout
openssl rsa -in openssl-example3.der -inform der -out openssl-example3.pem
openssl rsa -in openssl-example3.pem -text -noout
